...
gene_datasets{2}=harry_5Clusters_2;
gene_datasets{3}=harry_5Clusters_3;
gene_datasets{4}=harry_5Clusters_4;
gene_datasets{5}=harry_5Clusters_5;
...
dataset_labels = {'Harry cluster 1','Harry cluster 2','Harry cluster 3','Harry cluster 4','Harry cluster 5'};
...
%     saveas(fig,strcat('./figures_20180216/harry_cluster',num2str(d),'_nucleosomePositions.fig'));
end
